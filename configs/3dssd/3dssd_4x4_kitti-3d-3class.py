...
# project setting
project_name = '3dssd-kitti'
run_name = '3class-trial0907'
work_dir = './work_dirs/%s/%s'%(project_name, run_name)
...
data = dict(
    samples_per_gpu=6,
    workers_per_gpu=4,
    train=dict(dataset=dict(ann_file=data_root + "kitti_infos_train.pkl",
              pipeline=train_pipeline)),
    val=dict(ann_file=data_root + "kitti_infos_val.pkl",
             pipeline=test_pipeline),
    test=dict(ann_file=data_root + "kitti_infos_val.pkl",
              pipeline=test_pipeline))
